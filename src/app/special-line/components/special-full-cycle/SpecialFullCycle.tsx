...
import styles from './SpecialFullCycle.module.scss'

const SpecialFullCycle = () => {
	const data = [
		{
			logo: 'specialCycleSellerChina.svg',
			label: 'Логистика',
		...
		{
			logo: 'specialCycleStoRetail.svg',
			label: 'Маркетплейсы',
		...
		<div className={styles.container}>
			...
			<div className={styles.info}>
				<p className={styles.infoTop}>
					...
					<strong>доставка для маркетплейсов</strong>, проверка качества и
					отправка товаров на склады. С нашей услугой полного цикла доставки из
					Китая вы начнете продавать без лишних хлопот.
				</p>
...
export default SpecialFullCycle
